...
/*
예전 코드스테이츠 탐욕법 파트에서 풀어본 문제와 동일한 문제가 나왔다.
그때는 어떻게 풀었는지 기억이 잘 나지 않는데 아마 이중 반복문을 사용했던것으로 기억한다.
지금은 sort로 무게를 정렬하고 while을 이용하여 좌우를 움직인 뒤 2명씩 탄 보트를 전체 인원에서 빼주면 답이 나온다. 
*/
